...
另含用户新增的 `chart_knowledge_base.md`（100+ 图表速查：图级评级、数据类型要求、适用条件、避坑，2026-08 更新版）。
...
执行前先读 `tools/drawio/SKILL.md` 的完整工作流。技术路线图、研究内容全景图、分阶段流程图、
任务流水线图优先使用内置 `tools/drawio/scibox-diagram/` 四套论文级模板（sci-box），
选择与用法见 `scibox_templates.md`。
